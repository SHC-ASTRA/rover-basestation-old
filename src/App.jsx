    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/Rover-Control" element={<RoverControl/>}></Route>
                <Route path="/Arm-Control" element={<ArmControl/>}></Route>
                <Route path="/Biosensor-Control" element={<BiosensorControl/>}></Route>
                <Route path="/Autonomous-Control" element={<AutonomousControl/>}></Route>
            </Routes>
        </Router>
    );
}
