...
function rosFeed() {
    ...
    useEffect(() => {
        ...
        return () => {
            rosoutSub.unsubscribe();
        };
    }, []);

    return (
        <Card style={{ width: '100%' }}>
            <Card.Header className="h5">ROS Feed</Card.Header>
            <Card.Body>
                <textarea
                    id="ROSFeed"
...
function diagnostics() {
    ...
    return (
        <Card style={{ width: '25%' }}>
            <Card.Header className="h5">Diagnostics</Card.Header>
            <Card.Body>
...
function usageBar(name, barColor, usage) {
    ...
    return (
        <Card style={{ width: '33%' }}>
            <Card.Header className="h7">{name}</Card.Header>
...
function usage() {
    ...
    return (
        <Card style={{ width: '25%' }}>
            <Card.Header className="h5">Usage</Card.Header>
            <Card.Body>
...
function metric(name, nameColor, nameWidth, unit, metric) {
    return (
        <div>
            <InputGroup>
                <InputGroup.Text
                    style={{ width: nameWidth, backgroundColor: nameColor }}
                >
                    {name}:
                </InputGroup.Text>
                <Form.Control value={metric + ' ' + unit} readOnly />
            </InputGroup>
        </div>
    );
}
...
function gps() {
    ...
    return (
        <Card style={{ width: '25%' }}>
            <Card.Header className="h5">GPS</Card.Header>
            <Card.Body>
                <div className="d-grid">
                    {metric(
                        'Latitude',
...
function battery() {
    ...
    return (
        <Card style={{ width: '25%' }}>
            <Card.Header className="h5">Battery</Card.Header>
            <Card.Body>
                <div className="d-grid">
                    {metric(
                        'Charge',
...
function Status() {
    return (
        <Container className="p-4">
            ...
            <div className="card-deck">{rosFeed()}</div>
        </Container>
    );
}
